...
- A DaemonSet is like a [[12 ReplicaSets|ReplicaSet]], but it helps you run **exactly one copy of your pod per node.**
...
- The [[09 kube-proxy]] is also deployed as a DaemonSet.
...
- Modern DaemonSets rely on [[5 Node Affinity|node affinity]] behind the scenes rather than ad-hoc `nodeName` placement.
...
- Compare this with [[10 Static Pods]] when you need kubelet-managed pods instead of controller-managed pods.
