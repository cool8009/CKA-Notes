...
- This is the internal counterpart to [[14 Services - NodePort]].
...
- Again, to link the service to a set of pods, we will use a `selector`, just like in [[2 Labels and Selectors]]:
```
spec:
