...
- You need a scheduler to make sure that the right container ends up on the right ship (node), with regard to capacity, performance, policy etc. This is where rules like [[4 Node Selectors]], [[5 Node Affinity]], and [[11 Priority Classes|priority classes]] become relevant.
...
- Like the previous components, [[00 kubeadm|kubeadm]] deploys it on the control plane node.
